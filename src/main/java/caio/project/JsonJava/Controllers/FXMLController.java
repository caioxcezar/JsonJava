package caio.project.JsonJava.Controllers;

import caio.project.JsonJava.Models.Cliente;
import caio.project.JsonJava.JsonParser;
import java.net.URL;
...
public class FXMLController implements Initializable {
    ...
    private final String caminhoArquivo = "Assistencia.json";
    private Cliente cliSelecionado;

    @FXML
    private void buscarEnter(KeyEvent e){
